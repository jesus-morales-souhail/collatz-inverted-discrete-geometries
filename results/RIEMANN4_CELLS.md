...
With a fixed number of steps, $g$-orbits typically show much larger peak values and larger work $\sum_t F_t\,d_t$ with $F=\Delta\log(1+x)$, while $f$-orbits remain closer to the attractor region.
